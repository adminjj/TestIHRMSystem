...
class TestEmp(unittest.TestCase):
    ...
    def test01_test_emp_operation(self):
        ...
        # 打印修改员工的URL
        logging.info("修改员工的URL为：{}".format(modify_emp_url))
        # 发送修改员工接口请求
        response = requests.put(modify_emp_url,json={"username":"tom"},headers=headers)
        # 打印修改员工的结果
        ...
        # 打印删除员工的URL
        logging.info("删除员工的URL为：{}".format(modify_emp_url))
        # 发送删除员工接口请求
